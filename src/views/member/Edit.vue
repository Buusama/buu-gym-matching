                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                <div class="col-span-12 2xl:col-span-6">
                                    <div>
                                        ...
                                        <input v-model="name" type="text" class="form-control" placeholder="Tên hội viên" />
                                    </div>
                                    <div class="mt-3">
                                ...
                                <div class="col-span-12">
                                    <div class="mt-3">
                                        ...
                                        <textarea rows="8" v-model="address" class="form-control" placeholder="Địa chỉ">
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="h-40 relative image-fit  mx-auto">
                                    ...
                                    <Tippy v-if="newImage" tag="div" content="Remove this profile photo?"
                                        ...
                                        <xIcon @click="removePreview()" class="w-4 h-4" />
                                    </Tippy>
                                </div>
                                <div class="mx-auto cursor-pointer relative mt-5">
                                    ...
                                    <input id="form-avatar" type="file"
