      ...
      <ModalBody>
        <div class="p-5 text-center">
          ...
          <div class="text-gray-600 mt-2">
            Bạn có chắc muốn xóa huấn luyện viên này không? <br />Thay tác này sẽ không thể hoàn
            tác
          </div>
        </div>
  ...
  tabulator.value = new Tabulator(tableRef.value, {
    ...
    columns: [
      ...
      },
      {
        ...
        download: false,
        formatter(cell) {
          return `<div class="flex items-center lg:justify-center ${cell.getData().gender == 1
            ? "text-success"
